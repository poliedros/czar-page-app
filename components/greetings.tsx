...
export default function Greetings({ language }: Language) {
  return (
    <>
      <div
      ...
      >
        <Container>
          ...
          <h6 style={{ fontFamily: "'Source Sans Pro', sans-serif" }}>
            We are looking for people or companies interested in simple and
            focused projects or services
            <br />
            to solve problems for companies, organizations or communities.
          </h6>
        </Container>
      </div>
    </>
