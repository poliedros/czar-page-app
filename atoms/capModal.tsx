    ...
    var states = {
        ...
        Cloud: (
            <Row>
                ...
                <Col>
                    ...
                    <Button className="!flex items-center" variant="secondary" onClick={undefined}>
                        {getIconsByName("bs", "BsFillCloudArrowUpFill")}<span className="mr-1" />{translations("btnsendcloud", language)}
                    </Button>
                </Col>
            </Row>
        ),
                        ...
                        <Form.Group className="mb-3" controlId="formBasicEmail">
                            <Form.Control
                                ...
                                onChange={
                                    (
                                        v
                                    ) => {} /* this.setState({ emailTo: v.target.value }) */
                                }
                            />
                        ...
                        >
                            <Form.Control
                                ...
                                onChange={
                                    (
                                        v
                                    ) => {} /* this.setState({ emailBodyTo: v.target.value }) */
                                }
                            />
                        </Form.Group>
                        <Button
        ...
        Robot: (
            <Row>
                ...
                <Col>
                    <h4 className="font-normal">
                        {translations("newsrobot", language)}
                    </h4>
                    <div
                    ...
                    >
                        ...
                        >
                            <thead>
                                <tr>
                                    <th>
                                        {translations("number", language)}<br />
